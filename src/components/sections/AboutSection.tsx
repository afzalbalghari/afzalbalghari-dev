        ...
        >
          ...
          <motion.div variants={fadeRight} className="md:col-span-3 flex flex-col gap-6">
            <div className="flex flex-col gap-4">
              {[
                <>I'm a Full-Stack Developer and DevOps Engineer with <span className="text-text-primary font-medium">1+ years of hands-on experience</span> building production web applications and cloud infrastructure. I currently work at <span className="text-accent-teal font-medium">Netzing Technology</span> as a full-stack developer, where I build modern web applications and help deploy and maintain scalable systems in the cloud. I enjoy working across the entire development lifecycle—from creating responsive frontend interfaces to designing backend APIs and optimizing deployment workflows.</>,
                <>My journey into software began with curiosity about how websites work, which quickly grew into a deep passion for <span className="text-text-primary font-medium">clean code, developer experience, and thoughtfully engineered systems</span>. Today, I focus on building production-ready applications, improving performance, and automating development and deployment processes using modern full-stack and DevOps tools.</>,
                <>I enjoy solving real-world problems through technology—whether that means designing <span className="text-text-primary font-medium">efficient databases, building CI/CD pipelines, or creating intuitive user experiences.</span> Beyond coding, I spend time writing technical content, exploring open-source projects, and continuously expanding my knowledge in cloud architecture and software engineering.</>,
              ].map((para, i) => (
                <motion.p
                  key={i}
