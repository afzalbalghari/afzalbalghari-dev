...
export const skillGroups: SkillGroup[] = [
  { id:"frontend", icon:"🖥️", title:"Frontend", color:"green", skills:[
  ...
  { id:"backend", icon:"⚡", title:"Backend", color:"cyan", skills:[
  ...
  { id:"databases", icon:"🗄️", title:"Databases", color:"yellow", skills:[
  ...
  { id:"tools", icon:"🛠️", title:"Tools", color:"orange", skills:[
